...
def test_revoked_token_model_valid_expires_at_iso8601():
    token = TokenModel(
        ...
        jti=VALID_DATA["jti"],
        expires_at="2030-03-22T14:22:05+01:00",
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            TokenModel.get_refresh_tokens,
            TokenModel.get_refresh_token_by_token_id,
            TOKEN_OBJECT.update_refresh_token,
            TokenModel.delete_refresh_token_by_token_id,
        ),
        (
            TOKEN_OBJECT.insert_email_token,
            TokenModel.get_email_tokens,
            TokenModel.get_email_token_by_token_id,
            TOKEN_OBJECT.update_email_token,
            TokenModel.delete_email_token,
        ),
        (
            TOKEN_OBJECT.insert_revoked_token,
            TokenModel.get_revoked_tokens,
            TokenModel.get_revoked_token_by_token_id,
            TOKEN_OBJECT.update_revoked_token,
