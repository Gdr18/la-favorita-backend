...
JTI_PATTERN = re.compile("^[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89ab][a-f0-9]{3}-[a-f0-9]{12}$")
...
def test_token_valid_data():
    assert isinstance(TOKEN_OBJECT.user_id, str) and USER_ID_PATTERN.match(TOKEN_OBJECT.user_id)
