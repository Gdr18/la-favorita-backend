...
def test_update_product(client, mock_db, auth_header):
    return request_updating_resource(
        client, mock_db, auth_header, URL_PRODUCT_ID, VALID_PRODUCT_DATA, UPDATED_PRODUCT_DATA
    )
...
def test_product_route_duplicate_key_error(client, mock_db, auth_header, mocker):
    request_invalid_resource_duplicate_key_error(
        client, mock_db, auth_header, mocker, "post", URL_PRODUCT, VALID_PRODUCT_DATA, UPDATED_PRODUCT_DATA, "name"
    )
    request_invalid_resource_duplicate_key_error(
        client, mock_db, auth_header, mocker, "put", URL_PRODUCT_ID, VALID_PRODUCT_DATA, UPDATED_PRODUCT_DATA
    )
...
def test_product_route_resource_not_found_error(client, mock_db, auth_header):
    ...
    request_resource_not_found_error(
        client, mock_db, auth_header, "delete", URL_PRODUCT_ID, VALID_PRODUCT_DATA, RESOURCE
    )
