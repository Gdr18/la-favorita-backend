...
def test_add_setting_validation_error(client, mock_db, mocker, invalid_setting_data):
    return request_invalid_resource_validation_error(client, mock_db, mocker, 'post', URL_SETTING, invalid_setting_data)


def test_add_setting_unexpected_error(client, mocker):
    return request_unexpected_error(client, mocker, 'insert_one', URL_SETTING)
...
def test_get_settings_unexpected_error(client, mocker):
    return request_unexpected_error(client, mocker, 'find', URL_SETTINGS)
...
def test_get_setting_unexpected_error(client, mocker):
    return request_unexpected_error(client, mocker, 'find_one', URL_SETTING_ID)
...
def test_update_setting_validation_error(client, mock_db, mocker, invalid_setting_data):
    return request_invalid_resource_validation_error(client, mock_db, mocker, 'put', URL_SETTING_ID, invalid_setting_data)


def test_update_setting_unexpected_error(client, mock_db, mocker):
    return request_unexpected_error(client, mocker, 'find_one_and_update', URL_SETTING_ID)
...
def test_delete_setting_unexpected_error(client, mock_db, mocker):
    return request_unexpected_error(client, mocker, 'delete_one', URL_SETTING_ID)
